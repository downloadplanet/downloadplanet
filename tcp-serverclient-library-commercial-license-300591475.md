# TCP Server-Client Library Commercial License<br />![TCP Server-Client Library Commercial License](https://mycommerce.akamaized.net/api/pimages/P300591475/BIG/300591475.PNG)<br />TCP Server-Client Library is a component for use in Win32, Win64, OSX, iOS and Android software.
...
If none of these licenses match your requirements, or if you have any questions, get in touch (3delite@3delite.hu).<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300591475&affiliateid=200057808)