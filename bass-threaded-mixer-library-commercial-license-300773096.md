# BASS Threaded Mixer Library Commercial License<br />![BASS Threaded Mixer Library Commercial License](https://mycommerce.akamaized.net/api/pimages/P300773096/BIG/300773096.PNG)<br />BASS Threaded Mixer Library is a BASS add-on that implements a BASS mixer channel which mixes the pluged-in source channels in separate parallel threads to be used with professional low-latency ASIO output.
...
If none of these licenses match your requirements, or if you have any questions, get in touch (3delite@3delite.hu).<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300773096&affiliateid=200057808)