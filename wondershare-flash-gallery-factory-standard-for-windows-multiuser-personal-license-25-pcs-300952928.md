# Wondershare Flash Gallery Factory Standard for Windows - Multi-User Personal License (2-5 PCs)<br />![Wondershare Flash Gallery Factory Standard for Windows - Multi-User Personal License (2-5 PCs)](https://mycommerce.akamaized.net/api/pimages/P300952928/BIG/300952928.PNG)<br />It is a simple yet powerful flash slideshow maker, which helps you to combine photos and music into flash photo gallery in a few clicks.Starting from those built-in templates, you can instantly create engaging flash photo slideshow and gallery, flash photo album, business flash banner and much more without any flash or programming skills at all.
