# VideoLab ( Delphi/C++Builder Edition ) UPGRADE to Source Code-Single License<br />![VideoLab ( Delphi/C++Builder Edition ) UPGRADE to Source Code-Single License](https://mycommerce.akamaized.net/api/pimages/P179074/BIG/179074.JPG)<br />The VideoLab is a set of components, based on OpenWire technology for fast video capture, playback, broadcasting and processing. They allow fast complex video manipulations with zero lines of program code.
...
Waterfall Component - Waterfall component for Spectrum, and Histogram data representation.<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=179074&affiliateid=200057808)