# MKV Tag Library Commercial License<br />![MKV Tag Library Commercial License](https://mycommerce.akamaized.net/api/pimages/P300754390/BIG/300754390.PNG)<br />MKV Tag Library is a tag reader-writer component for Delphi (Win32, Win64) for Matroska container files (MKV, MKA).
...
If none of these licenses match your requirements, or if you have any questions, get in touch (3delite@3delite.hu).<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300754390&affiliateid=200057808)