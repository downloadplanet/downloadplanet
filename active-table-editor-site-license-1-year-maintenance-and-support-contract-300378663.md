# Active Table Editor - Site license (1 year maintenance and support contract)<br />Active Table Editor helps the users edit ANY table in ANY Database.
