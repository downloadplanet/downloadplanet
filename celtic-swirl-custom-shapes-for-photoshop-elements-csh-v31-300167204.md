...
Includes embellish custom shapes, foliage custom shapes, spiral scroll custom shapes, spiral custom shapes, basic custom shapes, curved custom shapes, curvy custom shapes, emboss spiral shapes, 3D spiral custom shapes and many more custom shapes for Adobe (R) Photoshop (R) + Adobe (R) Photoshop (R) Elements
