...
All the symbols for Adobe (R) Flash (R) stored in native FLA format
Easy to use via the symbols palette of Flash (R)
Many mixed symbols including circular symbols, 3D symbols, color symbols, arches symbols, twirls symbols, hearts symbols, sphere symbols, particle symbols, line symbols, grid symbols, warped symbols for Adobe (R) Flash (R)
