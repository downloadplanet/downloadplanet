...
100 Swirls and twirls shapes for Adobe (R) Photoshop (R) + Photoshop Elements + bonus shapes
Custom shapes are all royalty-free, use in many different projects, commercial or hobby or otherwise
Includes swirls custom shapes, galactic shapes, galaxy shapes, spiral shapes, folding custom shapes, angled custom shapes, twirl custom shapes, curved custom shapes, distorted shapes, overlay shapes and many more custom shapes for Adobe (R) Photoshop (R) + Adobe (R) Photoshop (R) Elements
