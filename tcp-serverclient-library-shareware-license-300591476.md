# TCP Server-Client Library Shareware License<br />![TCP Server-Client Library Shareware License](https://mycommerce.akamaized.net/api/pimages/P300591476/BIG/300591476.PNG)<br />TCP Server-Client Library is a component for use in Win32, Win64, OSX, iOS and Android software.
...
If none of these licenses match your requirements, or if you have any questions, get in touch (3delite@3delite.hu).<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300591476&affiliateid=200057808)