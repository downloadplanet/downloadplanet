# Sledge Process Library Shareware License<br />![Sledge Process Library Shareware License](https://mycommerce.akamaized.net/api/pimages/P300900588/BIG/300900588.PNG)<br />Sledge Process Library is a component for Delphi (Win32, Win64) based on Graphics32 that provides a powerful user configurable process construction.
...
If none of these licenses match your requirements, or if you have any questions, get in touch (3delite@3delite.hu).<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300900588&affiliateid=200057808)