# AnyMini C: Character Count Software - Corporate License: 4 PCs<br />![AnyMini C: Character Count Software - Corporate License: 4 PCs](https://mycommerce.akamaized.net/api/pimages/P300036062/BIG/300036062.GIF)<br />AnyMini C is automatic character count software. It is character count program for all common file formats, which supports .DOC, .RTF, .XLS, .PPT, .PPS, .HTM, .CSV,.
...
AnyMaxi: Text Count and Invoicing Software at http://www.anymaxi.com<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300036062&affiliateid=200057808)