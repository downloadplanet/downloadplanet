# VideoLab ( Delphi/C++Builder Edition ) Single License + Source Code<br />![VideoLab ( Delphi/C++Builder Edition ) Single License + Source Code](https://mycommerce.akamaized.net/api/pimages/P178621/BIG/178621.JPG)<br />VideoLab is a set of components, based on OpenWire technology for fast video capture, playback, broadcasting and processing. They allow fast complex video manipulations with zero lines of program code.
...
Waterfall Component - Waterfall component for Spectrum, and Histogram data representation.<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=178621&affiliateid=200057808)