# AnyMaxi: Word Count, Line Count, Character Count, and Invoicing Software - Site License<br />![AnyMaxi: Word Count, Line Count, Character Count, and Invoicing Software - Site License](https://mycommerce.akamaized.net/api/pimages/P300036087/BIG/300036087.GIF)<br />AnyMaxi is line count tool, character count tool, word count tool, and invoicing program.
...
The next logical step in using text count results is making invoice out of text count data you have got. Click the Invoice button to open Make Invoice dialog box.<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300036087&affiliateid=200057808)