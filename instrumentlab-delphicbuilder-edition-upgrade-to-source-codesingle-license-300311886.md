# InstrumentLab ( Delphi/C++Builder Edition ) UPGRADE to Source Code-Single License<br />![InstrumentLab ( Delphi/C++Builder Edition ) UPGRADE to Source Code-Single License](https://mycommerce.akamaized.net/api/pimages/P300311886/BIG/300311886.JPG)<br />InstrumentLab is a set of components, based on OpenWire technology for visual instrumentation.
The library is fully multi-threaded safe, and integrates directly with VideoLab, AudioLab, SignalLab, VisionLab, PlotLab, IntelligenceLab, BasicVideo, BasicAudio.
...
GDI+ rendered.
Included counters and time measuring components.<br />[>> Detailed information](https://secure.shareit.com/shareit/product.html?productid=300311886&affiliateid=200057808)